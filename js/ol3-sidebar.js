ol.control.Sidebar = function (settings) {
    ...
    this.element.classList.add('ol-sidebar-' + this._options.position);
    ...
    // Find ol-sidebar ul.ol-sidebar-tabs > li, ol-sidebar .ol-sidebar-tabs > ul > li
    this._tabitems = this.element.querySelectorAll('ul.ol-sidebar-tabs > li, .ol-sidebar-tabs > ul > li');
